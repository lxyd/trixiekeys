...
#ifdef SWAP_LEFT_ALTMETA
MAP_KEY(defmap, KEY_LEFTALT, KEY_LEFTMETA);
MAP_KEY(defmap, KEY_LEFTMETA, KEY_LEFTALT);
#endif
...
#ifdef SWAP_LEFT_ALTMETA
MAP_KEY(l3map, KEY_LEFTALT, KEY_LEFTMETA);
MAP_KEY(l3map, KEY_LEFTMETA, KEY_LEFTALT);
#endif
...
#ifdef SWAP_LEFT_ALTMETA
MAP_KEY(cplkmap, KEY_LEFTALT, KEY_LEFTMETA);
MAP_KEY(cplkmap, KEY_LEFTMETA, KEY_LEFTALT);
#endif
